...
import {
    CardBody, CardTitle,  Row, CardHeader, Col, Label,
} from "reactstrap";
...
class BestScoreVitesse extends Component {
    constructor(props) {
        super(props);
        this.state = {
            topfive: true,
    ...
    componentDidMount() {
        this.props.getBestScoreVitesse();
    }


    render() {
        console.log("best score getBestScoreVitesse");
        const {user} = this.props.auth;
        console.log(user.userId)
        const {unit_format} = this.props.unit_format;

        const {best_score_vitesse} = this.props.best_score_vitesse;
        console.log(best_score_vitesse);

        if (best_score_vitesse === undefined) {
            return (
                <div>
        ...
        if (best_score_vitesse.length === 0) {
            return (
                <div>
        ...
        for (var commonBrand in best_score_vitesse) {
            console.log(commonBrand)
            firstOne.push(best_score_vitesse[commonBrand][0])
        }
                                ...
                                <Table striped={"true"} style={{paddingLeft: '0px'}}>
                                    <Thead className="">
                                        <Tr style={{
                                            ...
                                            <Th style={{width: '20%'}}
                                                className="text-center">Player</Th>
                                            <Th style={{width: '40%'}}
                                                className="text-center">Rank</Th>
                                            <Th style={{width: '20%'}}
                                                className="text-center">Speed</Th>
                                        </Tr>
                                    </Thead>
                                    <Tbody>
                                                ...
                                                if (idx === 3) return (
                                                    <Tr key={idx} className="text-center">
                                                        ...
                                                        <Td>
                                                            ...
                                                            <MDBProgress animated material value={40} height="10px"
                                                                         style={{Color: '#53F3CE'}}>
                                                                40%
                                                            </MDBProgress>
                                                        ...
                                                        <Td>
                                                            {unit_format ?  <Label style={{
                                                                    ...
                                                                    {ranking.vitesse}                                                                </Label> :
                                                                <Label style={{
                                                                    fontFamily: 'panton ,sans-serif', color: 'white',
                                                                    fontSize: '18px '
                                                                }}>
                                                                    {ranking.vitesse*1000}
                                                                </Label>
                                                            }
                                                ...
                                                if (idx === 4) return (
                                                    <Tr key={idx} className="text-center">
                                                        ...
                                                        <Td>
                                                            ...
                                                            <MDBProgress animated material value={50} height="10px"
                                                                         style={{Color: '#53F3CE'}}>
                                                                50%
                                                            </MDBProgress>
...
BestScoreVitesse.propTypes = {
    getBestScoreVitesse: PropTypes.func.isRequired,
    best_score_vitesse: PropTypes.object.isRequired,
    auth: PropTypes.object.isRequired,
    unit_format: PropTypes.bool,

};
const mapStateToProps = (state) => ({
    best_score_vitesse: state.best_score_vitesse,
    auth: state.auth,
    unit_format: state.unit_format
});
export default connect(
    mapStateToProps,
    {getBestScoreVitesse})(BestScoreVitesse);